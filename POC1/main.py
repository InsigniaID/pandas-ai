...
# print(pandas_ai.run(df, prompt='Who are the top 3 players that had the most \
#               defensive rebounds? How many each?'))
#
# print(pandas_ai.run(df,"Plot the 3 point per game versus total score for each \
#               player on a scatter plot with small dots. Do not label with \
#                   player name, just the score on y-axis."))
#
# print(pandas_ai.run(df,"Please group all players for each of these positions \
...
#
# print(pandas_ai.run(df,"Plot a bar plot of all teams showing the average age of \
